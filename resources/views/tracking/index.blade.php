        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8" data-aos="fade-right">
                    ...
                    <p class="lead mb-0">Masukkan nomor permohonan Anda untuk melihat status terkini dan progress pengajuan
                        layanan</p>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="card border-0 h-100 text-center p-4"
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted small mb-0">Lacak status dengan mudah menggunakan nomor permohonan
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="card border-0 h-100 text-center p-4"
                                style="background: linear-gradient(135deg, #fff3e0 0%, #ffcc02 100%);">
                                <div class="card-body">
                                    <div class="mb-3">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                        ...
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Pastikan nomor permohonan yang dimasukkan benar dan
                                        sesuai dengan yang diterima saat pengajuan.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Hubungi layanan pelanggan atau datang langsung ke
                                        kantor Dinas PUPR.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-4" data-aos="fade-up" data-aos-delay="300">
                        <a href="{{ route('public.home') }}" class="btn btn-outline-primary me-3">
