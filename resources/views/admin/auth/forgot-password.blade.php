...
<head>
    ...
    <title>Lupa Password - {{ $profil->nama_instansi ?? 'Admin Dinas PUPR' }}</title>
        ...
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-md-6 col-lg-5">
                ...
                <div class="text-center logo-container">
                    @include('components.logo', ['style' => 'height: 60px;', 'class' => 'mb-3'])
                    <h4 class="fw-bold text-dark mb-1">Reset Password</h4>
                    <p class="text-muted mb-0">{{ $profil->nama_instansi ?? 'Admin Dinas PUPR Katingan' }}</p>
                </div>
                    ...
                    <div class="card-body p-5">
                            ...
                            <div class="alert alert-success d-flex align-items-start border-0 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">
                                        <i class="bi bi-info-circle me-1"></i>Silakan cek kotak masuk email Anda dan
                            ...
                            <div class="alert alert-warning d-flex align-items-start border-0 shadow-sm">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="bg-light p-3 rounded-3 mt-3">
                                        ...
                                        <ol class="mb-2 ps-3">
                                            <li class="mb-1"><strong>Hubungi Super Admin</strong> via email: <a
                                                    href="mailto:budiaat25@gmail.com"
                                                    class="text-decoration-none fw-bold">budiaat25@gmail.com</a></li>
                                            <li class="mb-1"><strong>Kirim permintaan reset password</strong> dengan
                                                menyertakan nama lengkap dan email akun Anda</li>
                                            <li class="mb-1"><strong>Super Admin akan memverifikasi</strong> identitas
                                                Anda untuk keamanan</li>
                                            <li class="mb-1"><strong>Super Admin akan login</strong> dan masuk ke menu
                                                <span class="badge bg-primary">Admin Management</span>
                                            </li>
                                            <li class="mb-1"><strong>Password baru akan dikirim</strong> ke email Anda
                                                setelah berhasil direset</li>
                                        </ol>
                                        <div class="alert alert-info border-0 mb-2 py-2">
                                            <small><i class="bi bi-envelope me-1"></i><strong>Email Super
                                                    Admin:</strong> <a
                                                    href="mailto:budiaat25@gmail.com">budiaat25@gmail.com</a></small>
                                        </div>
                                        <div class="alert alert-success border-0 mb-0 py-2">
                                            <small><i class="bi bi-clock me-1"></i><strong>Waktu Pelayanan:</strong>
                                                Senin-Jumat 08:00-16:00 WIB (Email 24/7)</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0"
                                        style="border-radius: 12px 0 0 12px; border: 2px solid #e3e6f0;">
                                        <i class="bi bi-envelope text-muted"></i>
                                    </span>
                                    <input id="email" type="email"
                                        class="form-control border-start-0 @error('email') is-invalid @enderror"
                                        name="email" value="{{ old('email') }}" required autocomplete="email"
                                        autofocus placeholder="admin@dinaspupr.com"
                        ...
                        <div class="mt-4 p-4 bg-light rounded-4 border">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="p-3 bg-success bg-opacity-10 rounded-3 border border-success border-opacity-25 h-100">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="p-3 bg-warning bg-opacity-10 rounded-3 border border-warning border-opacity-25 h-100">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="bi bi-shield-exclamation text-warning me-2"></i>
                                            <strong class="text-warning">Admin Biasa</strong>
                                        </div>
                                        <ul class="small mb-0 ps-3">
                                            <li class="mb-1">❌ <strong>TIDAK DAPAT</strong> menggunakan fitur reset
                                                password</li>
                                            <li class="mb-1">📞 Harus menghubungi Super Admin untuk reset password
                                            </li>
                                            <li class="mb-1">🔒 Akun dikelola sepenuhnya oleh Super Admin</li>
                                            <li class="mb-1">⚠️ Sistem akan menampilkan peringatan jika mencoba reset
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div
                                class="mt-4 p-3 bg-primary bg-opacity-10 rounded-3 border border-primary border-opacity-25">
                                <h6 class="fw-bold text-primary mb-3">
                                    <i class="bi bi-arrow-right-circle me-2"></i>Langkah Reset Password untuk Admin
                                    Biasa
                                </h6>
                                <div class="row g-2">
                            ...
                            <div class="mt-3 p-3 bg-info bg-opacity-10 rounded-3 border border-info border-opacity-25">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        <h6 class="fw-semibold text-info mb-2">Mengapa Sistem Keamanan Ini Diterapkan?
                                        </h6>
