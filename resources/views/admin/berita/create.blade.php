        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.konten.berita.store') }}" method="POST" enctype="multipart/form-data" id="beritaForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div id="visual-editor" class="visual-editor mb-2" 
                                 ...
                                 placeholder="Tulis konten berita di sini...">{{ old('konten') }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" 
                                   ...
                                   accept="image/*">
                            <div class="form-text">
                                Format yang diizinkan: JPG, JPEG, PNG, GIF. Maksimal 5MB.
                            </div>
                            @error('gambar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <!-- Status Publikasi -->
                        <div class="mb-3">
                            <label for="status_publikasi" class="form-label">
                                Status Publikasi <span class="text-danger">*</span>
                            </label>
                            <select class="form-select @error('status_publikasi') is-invalid @enderror" 
                                    id="status_publikasi" 
                                ...
                                <option value="archived" {{ old('status_publikasi') == 'archived' ? 'selected' : '' }}>
                                    Diarsipkan
                                </option>
                            </select>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {        
            ...
            const status = document.getElementById('status_publikasi').value;
