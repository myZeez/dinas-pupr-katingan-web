...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <p style="margin-bottom: 25px; color: #666;">Apakah Anda yakin ingin menghapus galeri "{{ $galeri->judul }}"?</p>
        <div class="btn-group">
...
@section('content')
                    ...
                    <div>
                        ...
                        @if ($galeri->deskripsi)
                            <div class="description-section">
                                <h5>Deskripsi</h5>
                                <div class="description-text">{!! $galeri->deskripsi !!}</div>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="info-panel">
                        ...
                        <table class="info-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge {{ $galeri->status === 'aktif' ? 'badge-success' : 'badge-danger' }}">
                                        {{ ucfirst($galeri->status) }}
                                    </span>
                                </td>
                            </tr>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <p>Apakah Anda yakin ingin menghapus galeri "{{ $galeri->judul }}"?</p>
            <div class="btn-group">
                <form action="{{ route('admin.konten.galeri.destroy', $galeri) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
