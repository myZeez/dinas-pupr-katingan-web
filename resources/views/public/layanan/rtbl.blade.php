...
<div class="container py-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Permohonan RTBL</li>
        </ol>
    </nav>

    <!-- Header -->
    <div class="text-center mb-4">
        <div class="d-inline-block p-3 rounded-circle mb-3" style="background: linear-gradient(135deg, #7c3aed 0%, #5b21b6 100%);">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="info-box">
                ...
                <p class="mb-0 small">
                    RTBL adalah pedoman rancang bangun suatu lingkungan/kawasan yang dimaksudkan untuk mengendalikan pemanfaatan ruang, penataan bangunan dan lingkungan, serta memuat materi pokok ketentuan program bangunan dan lingkungan, rencana umum dan panduan rancangan, rencana investasi, ketentuan pengendalian rencana, dan pedoman pengendalian pelaksanaan pembangunan.
                </p>
            </div>
            ...
            <div class="form-card p-4">
                <form action="{{ route('public.permohonan.store') }}" method="POST" enctype="multipart/form-data" id="rtblForm">
                    @csrf
                    ...
                    <div class="form-section" id="section-personal">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="instansi" class="form-label">Nama Instansi/Perusahaan <span class="text-danger">*</span></label>
                    ...
                    <div class="form-section d-none" id="section-project">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nama_proyek" class="form-label">Nama Proyek/Kawasan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nama_proyek" name="nama_proyek" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="jenis_kawasan" class="form-label">Jenis Kawasan <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="luas_kawasan" class="form-label">Luas Kawasan (Ha) <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nilai_investasi" name="nilai_investasi" 
                        ...
                        <div class="mb-3">
                            <label for="deskripsi_proyek" class="form-label">Deskripsi Proyek <span class="text-danger">*</span></label>
                            <textarea class="form-control" id="deskripsi_proyek" name="deskripsi_proyek" 
                                      rows="4" maxlength="3000" placeholder="Jelaskan konsep, tujuan, dan gambaran umum proyek RTBL..." required></textarea>
                    ...
                    <div class="form-section d-none" id="section-location">
                        ...
                        <div class="zone-card">
                            ...
                            <div class="mb-3">
                                <label for="alamat_lengkap" class="form-label">Alamat Lengkap Lokasi <span class="text-danger">*</span></label>
                    ...
                    <div class="form-section d-none" id="section-documents">
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">1</span> Surat Permohonan RTBL <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">2</span> Fotocopy KTP/Identitas Pemohon <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">4</span> Dokumen Kepemilikan Tanah <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">5</span> Peta Lokasi & Situasi <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">6</span> Proposal/Konsep Awal RTBL <span class="text-danger">*</span>
                            </label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateLocationInfo() {
        const required = ['kabupaten', 'kecamatan', 'kelurahan', 'alamat_lengkap', 'status_tanah', 'pemilik_tanah'];
        return required.every(field => {
            const input = document.getElementById(field);
            return input && input.value.trim() !== '';
        });
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                alert('Permohonan RTBL berhasil diajukan! Nomor permohonan: ' + data.nomor_permohonan);
