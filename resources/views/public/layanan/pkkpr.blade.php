...
<div class="container py-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Permohonan PKKPR</li>
        </ol>
    </nav>

    <!-- Header -->
    <div class="text-center mb-4">
        <div class="d-inline-block p-3 rounded-circle mb-3" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%);">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="info-box">
                ...
                <p class="mb-0 small">
                    PKKPR adalah persetujuan dari pemerintah daerah bahwa rencana kegiatan pemanfaatan ruang sesuai dengan rencana tata ruang. Persetujuan ini diperlukan sebelum memperoleh izin pemanfaatan ruang dan merupakan dasar penerbitan izin mendirikan bangunan.
                </p>
            </div>
            ...
            <div class="form-card p-4">
                <form action="{{ route('public.permohonan.store') }}" method="POST" enctype="multipart/form-data" id="pkkprForm">
                    @csrf
                    ...
                    <div class="form-section d-none" id="section-location">
                        ...
                        <div class="space-card">
                            ...
                            <div class="mb-3">
                                <label for="alamat_lokasi" class="form-label">Alamat Lengkap Lokasi <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="alamat_lokasi" name="alamat_lokasi" 
                                          rows="3" placeholder="Alamat lengkap beserta patokan/landmark" required></textarea>
                            </div>

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="koordinat_lat" class="form-label">Koordinat Latitude</label>
                                    <input type="text" class="form-control" id="koordinat_lat" name="koordinat_lat" 
                                           placeholder="-3.325000">
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="koordinat_lng" class="form-label">Koordinat Longitude</label>
                                    <input type="text" class="form-control" id="koordinat_lng" name="koordinat_lng" 
                                           placeholder="114.590000">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-card">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="status_tanah" class="form-label">Status Kepemilikan Tanah <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="nomor_sertifikat" class="form-label">Nomor Sertifikat/Dokumen <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="pemilik_tanah" class="form-label">Nama Pemilik Tanah <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="pemilik_tanah" name="pemilik_tanah" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section d-none" id="section-landuse">
                        ...
                        <div class="space-card">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="peruntukan_ruang" class="form-label">Peruntukan Ruang <span class="text-danger">*</span></label>
                                    <select class="form-select" id="peruntukan_ruang" name="peruntukan_ruang" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="intensitas_ruang" class="form-label">Intensitas Pemanfaatan <span class="text-danger">*</span></label>
                                    <select class="form-select" id="intensitas_ruang" name="intensitas_ruang" required>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="kdb" class="form-label">KDB (%) <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="kdb" name="kdb" 
                                           min="0" max="100" step="0.1" required>
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="klb" class="form-label">KLB <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="ketinggian_maks" class="form-label">Ketinggian Maksimal (lantai)</label>
                                    <input type="number" class="form-control" id="ketinggian_maks" name="ketinggian_maks" 
                                           min="1" step="1">
                                </div>
                            ...
                            <div class="mb-3">
                                <label for="kegiatan_detail" class="form-label">Detail Kegiatan yang Direncanakan <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="kegiatan_detail" name="kegiatan_detail" 
                        ...
                        <div class="space-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tinggi_bangunan" name="tinggi_bangunan" 
                                           min="1" step="0.1">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="estimasi_biaya" class="form-label">Estimasi Biaya Pembangunan (Rp)</label>
                                    <input type="text" class="form-control" id="estimasi_biaya" name="estimasi_biaya" 
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="rencana_mulai" name="rencana_mulai">
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="rencana_selesai" class="form-label">Rencana Selesai Pembangunan</label>
                                    <input type="date" class="form-control" id="rencana_selesai" name="rencana_selesai">
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="air_bersih" name="utilitas[]" value="air_bersih">
                                            <label class="form-check-label" for="air_bersih">Air Bersih</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="listrik" name="utilitas[]" value="listrik">
                                            <label class="form-check-label" for="listrik">Listrik</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="telepon" name="utilitas[]" value="telepon">
                                            <label class="form-check-label" for="telepon">Telepon/Internet</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="gas" name="utilitas[]" value="gas">
                    ...
                    <div class="form-section d-none" id="section-documents">
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">1</span> Surat Permohonan PKKPR <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">4</span> Peta Lokasi & Situasi <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">5</span> Rencana Tapak/Site Plan <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">7</span> Akta Pendirian Badan Usaha (jika pemohon badan usaha)
                            </label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateLocationInfo() {
        const required = ['kabupaten', 'kecamatan', 'kelurahan', 'alamat_lokasi', 'status_tanah', 'nomor_sertifikat', 'luas_tanah', 'pemilik_tanah'];
        return required.every(field => {
            const input = document.getElementById(field);
            return input && input.value.trim() !== '';
        });
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                alert('Permohonan PKKPR berhasil diajukan! Nomor permohonan: ' + data.nomor_permohonan);
