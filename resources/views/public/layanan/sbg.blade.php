...
@section('styles')
    <style>
        /* Custom sty        <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('public.home') }}">Beranda</a></li>
                <li class="breadcrumb-item active" aria-current="page">SBG</li>
            </ol>or SBG form */
        .form-card {
            border: none;
                ...
                <div class="form-card p-4">
                    <form action="{{ route('public.permohonan.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-section d-none" id="section-business">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="nama_usaha" class="form-label">Nama Usaha/Perusahaan <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="jenis_usaha" class="form-label">Jenis Usaha <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="alamat_usaha" class="form-label">Alamat Usaha <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control" id="alamat_usaha" name="alamat_usaha" rows="3"
                                    placeholder="Alamat lengkap lokasi usaha" required></textarea>
                            </div>

                            <div class="mb-3">
                                <label for="deskripsi" class="form-label">Deskripsi Kegiatan Usaha <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi"
                                    rows="4" maxlength="2000" placeholder="Jelaskan detail kegiatan usaha yang dilakukan..." required>{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="form-section d-none" id="section-documents">
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <span class="requirement-badge">1</span> Surat Permohonan <span
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <span class="requirement-badge">3</span> Fotocopy Akta Pendirian Perusahaan <span
                                        class="text-danger">*</span>
                                </label>
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <span class="requirement-badge">4</span> Surat Keterangan Domisili Usaha <span
                                        class="text-danger">*</span>
                                </label>
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <span class="requirement-badge">5</span> Denah Lokasi Usaha <span
                                        class="text-danger">*</span>
                                </label>
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <span class="requirement-badge">6</span> Surat Pernyataan Tidak Mengganggu Lingkungan
            ...
            nextBtn.addEventListener('click', function() {
                ...
                if (currentStep === 1) {
                    ...
                    if (!isValid) {
                        ...
                        'Mohon lengkapi semua data pribadi yang diperlukan.');
                        return;
                    }
                    ...
                    .then(data => {
                        if (data.success) {
                            showNotificationModal('success',
                                'Permohonan SBG berhasil diajukan! Nomor permohonan: ' + data
                                .nomor_permohonan,
                                function() {
