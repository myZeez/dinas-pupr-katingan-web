    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="info-box">
                ...
                <p class="mb-0 small">
                    Layanan konsultasi dan pemberian saran teknis untuk perencanaan pembangunan infrastruktur, bangunan gedung, dan tata ruang. Dapatkan panduan profesional dari ahli perencanaan untuk memastikan proyek Anda sesuai dengan standar dan regulasi yang berlaku.
                </p>
            </div>
            ...
            <div class="form-card p-4">
                <form action="{{ route('public.permohonan.store') }}" method="POST" enctype="multipart/form-data" id="adviceForm">
                    @csrf
                    ...
                    <div class="form-section" id="section-personal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="jabatan" class="form-label">Jabatan/Profesi <span class="text-danger">*</span></label>
                    ...
                    <div class="form-section d-none" id="section-consultation">
                        ...
                        <div class="consultation-card">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="jenis_konsultasi" class="form-label">Kategori Konsultasi <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="metode_konsultasi" class="form-label">Metode Konsultasi <span class="text-danger">*</span></label>
                                    <select class="form-select" id="metode_konsultasi" name="metode_konsultasi" required>
                            ...
                            <div class="mb-3">
                                <label for="masalah_dihadapi" class="form-label">Masalah/Tantangan yang Dihadapi <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="masalah_dihadapi" name="masalah_dihadapi" 
                            ...
                            <div class="mb-3">
                                <label for="solusi_diharapkan" class="form-label">Solusi/Hasil yang Diharapkan <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="solusi_diharapkan" name="solusi_diharapkan" 
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="lokasi_proyek" name="lokasi_proyek" 
                                           placeholder="Alamat atau lokasi proyek">
                                </div>
                    ...
                    <div class="form-section d-none" id="section-documents">
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <span class="requirement-badge">1</span> Surat Permohonan Konsultasi <span class="text-danger">*</span>
                            </label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateConsultationInfo() {
        const required = ['jenis_konsultasi', 'prioritas', 'metode_konsultasi', 'masalah_dihadapi', 'solusi_diharapkan'];
        return required.every(field => {
            const input = document.getElementById(field);
            return input && input.value.trim() !== '';
        });
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                alert('Permohonan Advice Planning berhasil diajukan! Nomor permohonan: ' + data.nomor_permohonan);
