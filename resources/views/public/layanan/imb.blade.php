    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">IMB</li>
            </ol>
        </nav>
                ...
                <div class="form-card p-4">
                    <form action="{{ route('public.permohonan.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-section d-none" id="section-building">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="fungsi_bangunan" class="form-label">Fungsi Bangunan <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="lokasi_bangunan" class="form-label">Lokasi Bangunan <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control" id="lokasi_bangunan" name="lokasi_bangunan" rows="3"
                                    placeholder="Alamat lengkap lokasi bangunan yang akan didirikan" required></textarea>
                            </div>

                            <div class="mb-3">
                                <label for="deskripsi" class="form-label">Deskripsi Bangunan <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi"
                                    rows="4" maxlength="2000" placeholder="Jelaskan detail bangunan yang akan didirikan..." required>{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="form-section d-none" id="section-documents">
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <span class="requirement-badge">4</span> Gambar Rencana Bangunan <span
                                        class="text-danger">*</span>
                                </label>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="upload-area" onclick="document.getElementById('doc5').click()">
                                    ...
                                    <p class="text-muted small">Format: PDF, DOC, DOCX (Max: 5MB) - Opsional untuk bangunan
                                        1 lantai</p>
                                </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    <span class="requirement-badge">6</span> Surat Pernyataan Tidak Keberatan Tetangga
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validateBuildingInfo() {
                const required = ['fungsi_bangunan', 'jumlah_lantai', 'luas_tanah', 'luas_bangunan',
                    'lokasi_bangunan', 'deskripsi'
                ];
                return required.every(field => {
                    const input = document.getElementById(field);
                    return input && input.value.trim() !== '';
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch(form.action, {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            alert('Permohonan IMB berhasil diajukan! Nomor permohonan: ' + data
                                .nomor_permohonan);
