        ...
        <div class="row align-items-center min-vh-50">
            ...
            @if($profil && $profil->foto_profil)
                <div class="col-lg-4 text-center" data-aos="fade-left">
                    <img src="{{ $profil->foto_profil_url }}" 
            ...
            <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold text-primary">{{ $hierarki->sum(function($h) { return $h->children->count() + 1; }) }}</h3>
                ...
                <div class="carousel-inner rounded-4 shadow-lg">
                    @foreach($carousel as $index => $item)
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                            <img src="{{ $item->media_url }}" class="d-block w-100" style="height: 400px; object-fit: cover;">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="card border-0 shadow-lg h-100">
                            <div class="position-relative">
                                @if($video->media)
                                    <img src="{{ $video->media_url }}" class="card-img-top" style="height: 200px; object-fit: cover;">
                                @else
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card bg-white text-dark border-0 shadow h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted">{{ $profil->telepon ?? 'Nomor telepon akan segera ditambahkan' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 text-center" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            @if($profil->facebook)
                                <a href="{{ $profil->facebook }}" target="_blank" class="btn btn-light btn-lg rounded-circle">
                                    <i class="fab fa-facebook fa-lg text-primary"></i>
                                </a>
                            @endif
                            @if($profil->instagram)
                                <a href="{{ $profil->instagram }}" target="_blank" class="btn btn-light btn-lg rounded-circle">
                                    <i class="fab fa-instagram fa-lg text-danger"></i>
                                </a>
                            @endif
                            @if($profil->youtube)
                                <a href="{{ $profil->youtube }}" target="_blank" class="btn btn-light btn-lg rounded-circle">
                                    <i class="fab fa-youtube fa-lg text-danger"></i>
                                </a>
                            @endif
                            @if($profil->website)
                                <a href="{{ $profil->website }}" target="_blank" class="btn btn-light btn-lg rounded-circle">
