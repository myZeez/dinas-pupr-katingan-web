...
@section('content')
<!-- Hero Section -->
<section class="py-4 py-md-5 text-white" style="background: linear-gradient(135deg, var(--secondary-color) 0%, #001f5c 100%);">
    <div class="container">
            ...
            @foreach($strukturByJabatan as $jabatanGroup)
                ...
                <div class="row justify-content-center mb-4">
                    @foreach($jabatanGroup['anggota'] as $anggota)
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-3" data-aos="zoom-in" data-aos-delay="{{ ($loop->parent->index * 50) + ($loop->index * 30) }}">
                                    ...
                                    <div class="border-top pt-3">
                                        @if($anggota->nip)
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <small class="text-muted"><i class="fas fa-id-card me-1"></i>NIP:</small>
                                        ...
                                        @if($anggota->golongan)
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <small class="text-muted"><i class="fas fa-star me-1"></i>Golongan:</small>
